...
public class GameSession : MonoBehaviour
{
    ...
    public static void LoadFromSave(SaveData save)
    {
        ...
        DayManager.Instance.SetDay(save.day);
    ...
    private void ApplyLoadedState()
    {
        ...
        // The death HUD can pause the persistent gameplay rig again while the
        // scene reload is completing. Release that modal only after the saved
        // player state has been restored, so a living player cannot stay frozen.
