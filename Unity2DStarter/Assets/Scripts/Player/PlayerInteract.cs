...
public class PlayerInteract : MonoBehaviour
{
    ...
    private void Start()
    {
        modalWasOpen = GameModal.IsOpen;
        RefreshInteractables();
    }

    public void RefreshInteractables()
    {
        var allMono = FindObjectsByType<MonoBehaviour>(FindObjectsInactive.Exclude);
    ...
    private void Update()
    {
        ...
        bool modalOpen = GameModal.IsOpen;
        ...
        if (modalOpen || (stats != null && stats.IsDead))
        {
            return;
        }
