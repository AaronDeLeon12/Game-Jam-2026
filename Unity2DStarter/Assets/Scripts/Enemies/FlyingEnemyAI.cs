...
public class FlyingEnemyAI : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (definition != null)
        {
            ...
            dashDamage = definition.attackDamage;
            dashCooldown = definition.attackCooldown;
        }
        if (GetComponent<Animator>() != null)
        { spriteRenderer = GetComponent<SpriteRenderer>(); chargeGlowRenderer = transform.Find("Charge Glow").GetComponent<SpriteRenderer>(); }
        else SetupVisual();
