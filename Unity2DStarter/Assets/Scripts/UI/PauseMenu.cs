...
public class PauseMenu : MonoBehaviour
{
    ...
    private void Update()
    {
        if (Input.GetKeyDown(KeyCode.Escape) && !GameModal.IsOpen && (SystemsBootstrap.Instance == null || !SystemsBootstrap.Instance.PlayerStats.IsDead))
        {
            if (IsPaused)
            {
                Resume();
    ...
    public void ResumeFromCanvas() { Resume(); }
